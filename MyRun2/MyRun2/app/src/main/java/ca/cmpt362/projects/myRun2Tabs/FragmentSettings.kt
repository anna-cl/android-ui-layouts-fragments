        ...
        listViewMid.setOnItemClickListener(){ parent: AdapterView<*>, view: View, position: Int, id: Long ->
            if (position == 0){//unit preference --> choice dialog
                ...
                dialogBuilder.setSingleChoiceItems(units, -1) { dialogInterface, i ->
                    //Load comment data:
//                    val sharedRadioButton : String? = getSharedPreferences.getString("unit_settings_key", null)
//                    lateinit var radioButton: RadioButton
//                    if (sharedRadioButton.equals("Metric(Kilometers)")){
////                        radioButton =
//                        radioButton.setChecked(true)
//                    }else if(sharedRadioButton.equals("Imperial(Miles)")){
